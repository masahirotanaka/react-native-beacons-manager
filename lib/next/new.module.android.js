...
function getRNLogs(): Promise<Array<string>> {
  return new Promise((resolve, reject) => {
    BeaconsManager.getRNLogs(resolve);
  });
}
...
function transmitBeacon(uuid: string, major: number, minor: number, measuredPower: number): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.transmitBeacon(uuid, major, minor, measuredPower, resolve, reject);
  });
}

function stopTransmittingBeacon(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.stopTransmittingBeacon(resolve, reject);
  });
}
